...
const ProgressOverlay = ({ value, max }: { value: number; max: number }) => {
  return (
    <Portal container={document.body}>
      ...
      <div
        className="fixed top-1/2 left-1/2 z-[88] flex max-h-[85vh] w-[90%] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col items-center space-y-6 rounded-lg bg-zinc-100 p-8 dark:bg-zinc-800"
        role="dialog"
